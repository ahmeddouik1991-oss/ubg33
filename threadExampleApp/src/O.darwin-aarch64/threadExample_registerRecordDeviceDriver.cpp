...
/* Generated from ../O.Common/threadExample.dbd */
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_devLsiEnviron, *pvar_dset_devthreadExampleVersion,
...
static const char * const deviceSupportNames[] = {
    ...
    "devthreadExampleVersion", "devLsoSoft", "devLsoSoftCallback",
...
epicsShareExtern reg_func pvar_func_QSRVRegistrar,
    ...
    pvar_func_threadExampleRegister, pvar_func_tsInitialize,
...
int threadExample_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/Users/ahdo1293/EPICS";
    ...
    runRegistrarOnce(pvar_func_threadExampleRegister);
...
/* threadExample_registerRecordDeviceDriver */
...
static const iocshFuncDef rrddFuncDef = {
    ...
    "Example: threadExample_registerRecordDeviceDriver pdbbase\n",
};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(threadExample_registerRecordDeviceDriver(*iocshPpdbbase));
}
