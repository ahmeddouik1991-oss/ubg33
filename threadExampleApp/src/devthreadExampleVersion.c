...
#include "threadExampleVersion.h"

/* must be last include */
#include "epicsExport.h"

const char version[] = threadExampleVERSION;
...
static lsidset devthreadExampleVersion = {
    {5, NULL, NULL, NULL, NULL}, read_string
};
epicsExportAddress(dset,devthreadExampleVersion);
